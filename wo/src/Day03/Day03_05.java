...
public class Day03_05 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// for :
			// 어디서부터 어디까지 몇개식 증가/감소 하면서 반복처리
				// 1부터 10까지 1씫 증가하면서 반복처리 => 10번 실행
		...
		// p.121 예제1 
			for( int i = 1 ; i<=10 ; i++ ) {
				...
				System.out.print( i + " ");
					...
					//--------------------------------
					// i = 10 일때 i<=10 [ true ] 실행문 -> 증감식 i=10 -> 증감식 i=11
					// i = 11 일때 i<=10 [ false ] q -> 증감식 i=3
			...
			// p.122 예제2 : 1부터 100까지 누적합 출력
				for( int i = 1 ; i<=100 ; i++ ) {
					//* i 는 1부터 100까지 1씩 증가하면서 실행문 반복처리
					sum += i; // sum = sum + i;
				} // 반복문 종료
