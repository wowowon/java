...
public class Day06_06 { // c s
	...
	public static void main(String[] args) { // m s
		...
		Board[] boardlist = new Board[100];	// * Board 객체를 100개를 저장할수 있는 1차원 배열 선언
			// * Board 객체를 100개 저장할수 있는 1차원 배열 서언
...
/////////////////////////////////////// 글쓰기 /////////////////////////////////
			...
			// 반복문 사용 목적 x -> 출력할위치[인덱스] 입력 받았기 때문에 -> 입력받은 인덱스 위치에 객체
	...
	/////////////////////////////////////////// 글 삭제 ///////////////////////////////////			
				...
				// 반복문 x 검색 x => 삭제할 인덱스 위치를 입력받았기 때문에
				if( boardlist[bno].password.equals(password) ) {
					System.out.println(" 알림)) 삭제 성공 ");
					boardlist[bno] = null; // 해당 게시물에 null 대입 // 삭제처리
	...
	/////////////////////////////////////////////글 수정//////////////////////////			
				// 1. 비밀번호 입력받기
				System.out.println(" 알림)) 현 게시물 비밀번호 : "); String password = scanner.next();
				// 2. bno : 현게시물(보고있는 게시물)의 인덱스 객체네 비밀번호가 입력받은 비밀번호가 통일하면
				if( boardlist[bno].password.equals(password) ) {
					// 해당 게시무르이 제목과 내용을 새로 입력받아 현 게시물객체에 대입 .
