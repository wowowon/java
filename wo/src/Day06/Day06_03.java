	...
	public static void main(String[] args) { // m s
		...
		while(true) { // 프로그램 실행 무한루프 [ 종료조건:x }
			...
			if( ch == 1 ) { // 회원가입
				...
				boolean logincheck = false; // true : 로그인성공 false : 로그인 실패 으로 사용될 목적
				for( Member temp : memberlist ) {
					// * memberlist내 0번 인덱스부터 끝 인덱스 까지 하나씩 temp에 
