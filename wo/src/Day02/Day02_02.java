...
public class Day02_02 { // c s
	public static void main(String[] args) { // m s
		...
		// ; " 실행 단위 구분
		// 동일한 변수명은 사용할수 없다. [ 이름이 중복되면 오류(구분불가ㅏ) ]
		// p.40 byte : 1바이트+-128
		...
		// p.43 char : 2바이트 [ 1문자 ] : 유니코드 (자바 , 2바이트;전세계 모든문자) vs 아스키코드(c언어)
	    ...
	    //	short num = 40000;	System.out.println( num2 ); // 오류 발생
	    ...
	    // P.46 long : 8 바이트 정수 +- 20억이상 
	    long num5 = 10000000000L;		System.out.println( num5 );
	    			// INT형	 -> long형
	    
	    // p47~48 float[ 데이터뒤에 f ] : 4바이트 / double( 실수 기본타입 ) : 8바이트 : 17자리
	    ...
	    // p .48 boolean : 1비트 [ 참 혹은 거짓 ]
	    	// 스위치 : on , OFF
	    boolean bo1 = true; System.out.println( bo1 );
	    
	    // p.49 : 타입 변환
	    	//        ---------->>>>>---------- 자동형변환 방향 ---------->>>>
	    	//* 크기순서 : byte -> shotr ->int -> long -> float -> doublr
	    	// 1. 자동 형변환 :
	    		// 작은 상자에서 큰상자로 이동 가능	
	    		// 큰상자에서 작은 상자로 이동 불가
	    	byte 바이트 = 10;
