...
public class Day02_05 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// 1. 입력객체 
				...
				System.out.println(" 입력한 정수는 7의배수 이면서 판단 : " + ( 문제5%7 == 0 && 문제5%2 == 0 ) );
				...
				//문제7 : 반지름을 입력받아 원 넓이 출력하기 
			 	...
			 	System.out.print(" 문제7) 정수입력 : "); int 문제7= scanner.nextInt();
				...
				//문제13:  중간고사, 기말고사, 수행평가를 입력받아 반영비율별 계산하기
						...
						//기말고사 반영비율 => 30 %
						//수행평가 반영비율 => 40 %
			 	System.out.print(" 문제 13) 중간고사 : "); double 중간고사 = scanner.nextDouble();
			 	System.out.print(" 문제 13) 기말고사 : "); double 기말고사 = scanner.nextDouble();
			 	System.out.print(" 문제 13) 수행평가 : "); double 수행평가 = scanner.nextDouble();
				...
				System.out.println("문제17) 정수4  : "); int 정수4=scanner.nextInt();
				System.out.println("문제17) 정수5  : "); int 정수5=scanner.nextInt();
				System.out.println("문제17) 정수6  : "); int 정수6=scanner.nextInt();
				System.out.println("문제17) 정수7  : "); int 정수7=scanner.nextInt();
